...
public class interval_C
{
	...
	/**
	 * The function indicates whether the provided value is below the lower border of the interval.
	 * 
	 * @param arg: provided value
	 * @return: TRUE if below; FALSE - otherwise
	 */
	public boolean IsBelow(double arg)
	{
		boolean is_below;
		
		if(arg < le.doubleValue())
		{
			is_below = true;
		}
		else
	...
	/**
	 * The function indicates whether the provided value is above the upper border of the interval.
	 * 
	 * @param arg: provided value
	 * @return: TRUE if above; FALSE - otherwise
	 */
	public boolean IsAbove(double arg)
	{
		boolean is_above;
		
		if(arg > ri.doubleValue())
		{
			is_above = true;
		}
		else
	...
	/**
	 * The function indicates whether the provided value is within the borders of the interval.
	 * 
	 * @param arg: provided value
	 * @return: TRUE if within; FALSE - otherwise
	 */
	public boolean IsInside(double arg)
	{
		boolean is_inside;
		
		if(arg >= le.doubleValue() && arg <= ri.doubleValue())
		{
			is_inside = true;
		}
		else
