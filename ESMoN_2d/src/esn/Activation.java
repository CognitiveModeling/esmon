...
public class Activation {
	...
	public enum activation_E {
			...
			LOGISTIC_IN,//inverse of the logistic function
			...
			public static activation_E getInverseFunction(activation_E func)
			{
				...
				switch (func)
				{
					...
					case LIM_ID05:
						...
						break;
					case LOGISTIC:
						inverse_funcion = LOGISTIC_IN;
						break;
					case LOGISTIC_IN:
						inverse_funcion = LOGISTIC;
						break;
					default:
	...
	public double calculateValue(double v)
	{
		...
		switch (_activation)
		{
			...
			case LIM_ID05:
				...
				break;
			case LOGISTIC:
				returnValue = 1 / (1 + Math.exp(-v));
				break;
			case LOGISTIC_IN:
				if(v<0 || v>1)
				{
					System.err.println("calculateValue: logistic function is not defined outside (0, 1)");
					System.exit(1);
				}
				returnValue = -Math.log( (1 / v) - 1 );
				break;
			default:
